...
export function PageIntro({ eyebrow, title }: { eyebrow: string; title: string }) {
 return <section className="relative overflow-hidden bg-brand py-16 sm:py-20 lg:py-24"><div className="absolute inset-y-0 right-0 w-1/3 border-l border-brand-foreground/10 bg-brand-light/20 [clip-path:polygon(35%_0,100%_0,100%_100%,0_100%)]"/><div className="container-shell relative max-w-5xl"><p className="mb-4 text-xs font-extrabold uppercase tracking-label text-primary">{eyebrow}</p><h1 className="text-3xl font-extrabold leading-tight text-brand-foreground sm:text-4xl lg:text-5xl">{title}</h1></div></section>;
}
